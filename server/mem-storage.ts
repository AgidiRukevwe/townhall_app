...
export class MemStorage implements IStorage {
  ...
  private officials: Official[] = [
    {
      ...
      term: "2023-2027",
      imageUrl:
        "https://www.vanguardngr.com/wp-content/uploads/2023/03/Bola-Tinubu.webp",
      approvalRating: 46,
      approvalTrend: -5,
      createdAt: new Date(),
      updatedAt: new Date(),
    ...
    },
    {
      ...
      term: "2023-2027",
      imageUrl:
        "https://dailypost.ng/wp-content/uploads/2022/07/Kashim-Shettima.jpeg",
      approvalRating: 51,
      approvalTrend: 2,
      createdAt: new Date(),
      updatedAt: new Date(),
    ...
    },
    {
      ...
      term: "2023-2027",
      imageUrl:
        "https://dailypost.ng/wp-content/uploads/2023/06/Godswill-Akpabio-1.jpeg",
      approvalRating: 48,
      approvalTrend: -1,
      createdAt: new Date(),
      updatedAt: new Date(),
    ...
    },
    {
      ...
      term: "2023-2027",
      imageUrl:
        "https://guardian.ng/wp-content/uploads/2023/03/Babajide-Sanwo-Olu.jpg",
      approvalRating: 62,
      approvalTrend: 4,
      createdAt: new Date(),
      updatedAt: new Date(),
    ...
    },
    {
      ...
      term: "2023-2027",
      imageUrl:
        "https://dailypost.ng/wp-content/uploads/2022/10/Peter-Ndubuisi-Mbah.jpeg",
      approvalRating: 55,
      approvalTrend: 7,
      createdAt: new Date(),
      updatedAt: new Date(),
  ...
  async getOfficialRatings(officialId: string): Promise<RatingSummary> {
    ...
    for (let i = 5; i >= 0; i--) {
      ...
      const pastRating =
        i === 0
          ...
          : Math.max(
              30,
              Math.min(70, rating - trend * (i / 2) + (Math.random() * 10 - 5))
            );
    ...
    const sectorRatings = [
      {
        name: "Healthcare",
        rating: Math.floor(rating - 10 + Math.random() * 20),
  ...
  async submitRating(
    ...
    if (official) {
      ...
      official.approvalRating = Math.round(
        (official.approvalRating * 5 + ratingData.overallRating) / 6
      );

      // Randomly update the trend
      official.approvalTrend = Math.round(
        official.approvalTrend +
          (ratingData.overallRating - official.approvalRating) / 2
      );
    }

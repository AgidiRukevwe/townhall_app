...
// import { createEmptyTimeData } from "./create-empty-time-data";
// import { fillDataGaps } from "./fill-data-gaps";
// import {
//   generateDayLabels,
//   generateWeekLabels,
//   generateMonthLabels,
...
//   const { dayStart, weekStart, yearStart, multiYearStart } =
//     generateTimeRanges(now);
//   const dayLabels = generateDayLabels(now);
//   const weekLabels = generateWeekLabels(now);
//   const monthLabels = generateMonthLabels(now);
//   const yearLabels = generateYearLabels(now);

//   const timeData = {
//     periods: {
//       "1 Dy": { label: dayLabels, data: new Array(24).fill(0) },
//       "1 Wk": { label: weekLabels, data: new Array(7).fill(0) },
//       "1 Yr": { label: monthLabels, data: new Array(12).fill(0) },
//       "This year": { label: yearLabels, data: new Array(7).fill(0) },
//     },
//     sectorData: {
...
//   // Extracted logic: initialize sectors, populate data, average out, fill gaps
//   // To keep the function modular, move each of those steps into a helper if needed

//   for (const rating of ratings) {
//     const hour = rating.createdAt.getHours();
//     const day = rating.createdAt.getDay();
//     const month = rating.createdAt.getMonth();
//     const year = rating.createdAt.getFullYear();

//     // === "1 Dy" ===
//     if (rating.createdAt >= dayStart) {
//       timeData.periods["1 Dy"].data[hour] += rating.rating ?? 0;

//       if (rating.sectorName) {
//         const sectorId = rating.sectorName.toLowerCase().replace(/\s+/g, "_");
//         const sector = timeData.sectorData["1 Dy"][sectorId] ?? {
//           sectorId,
//           color: rating.sectorColor ?? "#999",
//           data: new Array(24).fill(0),
//         };
//         sector.data[hour] += rating.rating ?? 0;
//         timeData.sectorData["1 Dy"][sectorId] = sector;
//       }
//     }

//     // === "1 Wk" ===
//     if (rating.createdAt >= weekStart) {
//       timeData.periods["1 Wk"].data[day] += rating.rating ?? 0;

//       if (rating.sectorName) {
//         const sectorId = rating.sectorName.toLowerCase().replace(/\s+/g, "_");
//         const sector = timeData.sectorData["1 Wk"][sectorId] ?? {
//           sectorId,
//           color: rating.sectorColor ?? "#999",
//           data: new Array(7).fill(0),
//         };
//         sector.data[day] += rating.rating ?? 0;
//         timeData.sectorData["1 Wk"][sectorId] = sector;
//       }
//     }

//     // === "1 Yr" ===
//     if (rating.createdAt >= yearStart) {
//       timeData.periods["1 Yr"].data[month] += rating.rating ?? 0;

//       if (rating.sectorName) {
//         const sectorId = rating.sectorName.toLowerCase().replace(/\s+/g, "_");
//         const sector = timeData.sectorData["1 Yr"][sectorId] ?? {
//           sectorId,
//           color: rating.sectorColor ?? "#999",
//           data: new Array(12).fill(0),
//         };
//         sector.data[month] += rating.rating ?? 0;
//         timeData.sectorData["1 Yr"][sectorId] = sector;
//       }
//     }

//     // === "This year" (multi-year view, e.g. 7-year window) ===
//     const yearDiff = now.getFullYear() - year;
//     if (yearDiff < 7) {
//       timeData.periods["This year"].data[6 - yearDiff] += rating.rating ?? 0;

//       if (rating.sectorName) {
//         const sectorId = rating.sectorName.toLowerCase().replace(/\s+/g, "_");
//         const sector = timeData.sectorData["This year"][sectorId] ?? {
//           sectorId,
//           color: rating.sectorColor ?? "#999",
//           data: new Array(7).fill(0),
//         };
//         sector.data[6 - yearDiff] += rating.rating ?? 0;
//         timeData.sectorData["This year"][sectorId] = sector;
//       }
//     }
//   }

//   // --- Implement the rest similar to your logic using extracted functions as needed ---

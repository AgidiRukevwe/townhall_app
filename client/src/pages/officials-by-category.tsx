...
export default function OfficialsCategoryPage() {
  ...
  // For navbar, assuming you have user info if needed (dummy here)
  const [searchInput, setSearchInput] = useState("");
  const userName = ""; // Replace with your auth logic if needed
    ...
    <main className="flex-1 bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 pt-14">
        ...
        {error ? (
          ...
          <div className="gap-x-2flex overflow-x-auto gap-12 pb-2 hide-scrollbar">

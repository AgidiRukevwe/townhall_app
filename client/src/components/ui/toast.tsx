...
const toastVariants = cva(
  "group pointer-events-auto relative flex w-full items-center space-x-4 overflow-hidden rounded-2xl p-4 transition-all data-[swipe=cancel]:translate-y-0 data-[swipe=end]:translate-y-[var(--radix-toast-swipe-end-y)] data-[swipe=move]:translate-y-[var(--radix-toast-swipe-move-y)] data-[swipe=move]:transition-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[swipe=end]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-top-full data-[state=open]:slide-in-from-top-full duration-300",
  {
    variants: {
      variant: {
        default: "bg-[#F5F5F5]",
...
>(({ className, variant = "default", ...props }, ref) => {
  ...
  if (variant === "success") {
    ...
    icon = <Icon name="TickCircle" size={24} color="#3B82F6" variant="Bold" />;
  }
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description
    ref={ref}
    className={cn("text-sm pt-1 text-[#737373]", className)}
    {...props}
  />
));

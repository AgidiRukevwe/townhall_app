...
export interface TimeDataBySector {
  [sectorName: string]: {
    sectorId: string;
    color: string;
    data: number[];
...
export interface RatingSummary {
  ...
  // Time-based data with specific period data and sector breakdowns
  timeData?: {
    periods: {
      "1 Dy": TimeDataset;
      "1 Wk": TimeDataset;
      "1 Yr": TimeDataset;
      "This year": TimeDataset;
    };
    // For each time period, contains data by sector
    sectorData: {
      "1 Dy": TimeDataBySector;
      "1 Wk": TimeDataBySector;
      "1 Yr": TimeDataBySector;
